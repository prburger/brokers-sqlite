 ...
 */
final class Version20210118024843 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, specifications_id INTEGER NOT NULL, notes_id INTEGER DEFAULT NULL, customer_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, supplier_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, name VARCHAR(120) NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, CONSTRAINT FK_D34A04ADFC56F556 FOREIGN KEY (notes_id) REFERENCES note (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D34A04ADBDE4EC11 FOREIGN KEY (specifications_id) REFERENCES specification (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
