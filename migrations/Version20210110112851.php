 ...
 */
final class Version20210110112851 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_81398E095316C376');
        $this->addSql('DROP INDEX UNIQ_81398E09E7A1254A');
        $this->addSql('DROP INDEX IDX_81398E09A5905F5A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, contact_id, messages_id, brokers_id, name, date_added, date_edited FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contact_id INTEGER NOT NULL, messages_id INTEGER NOT NULL, broker_id INTEGER NOT NULL, name VARCHAR(120) NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, CONSTRAINT FK_81398E09A5905F5A FOREIGN KEY (messages_id) REFERENCES message (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_81398E096CC064FC FOREIGN KEY (broker_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_81398E09E7A1254A FOREIGN KEY (contact_id) REFERENCES contact (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO customer (id, contact_id, messages_id, broker_id, name, date_added, date_edited) SELECT id, contact_id, messages_id, brokers_id, name, date_added, date_edited FROM __temp__customer');
        $this->addSql('DROP TABLE __temp__customer');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_81398E09E7A1254A ON customer (contact_id)');
        $this->addSql('CREATE INDEX IDX_81398E09A5905F5A ON customer (messages_id)');
        $this->addSql('CREATE INDEX IDX_81398E096CC064FC ON customer (broker_id)');
        $this->addSql('DROP INDEX IDX_B6BD307F355AF43');
        $this->addSql('DROP INDEX IDX_B6BD307FC3568B40');
        $this->addSql('DROP INDEX IDX_B6BD307F5316C376');
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, suppliers_id, customers_id, brokers_id, broker_id, customer_id, supplier_id, text, date_added, date_edited, sent_by FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, suppliers_id INTEGER NOT NULL, customers_id INTEGER NOT NULL, brokers_id INTEGER NOT NULL, broker_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, customer_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, supplier_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, text CLOB NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_B6BD307F355AF43 FOREIGN KEY (suppliers_id) REFERENCES supplier (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307FC3568B40 FOREIGN KEY (customers_id) REFERENCES customer (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F5316C376 FOREIGN KEY (brokers_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO message (id, suppliers_id, customers_id, brokers_id, broker_id, customer_id, supplier_id, text, date_added, date_edited, sent_by) SELECT id, suppliers_id, customers_id, brokers_id, broker_id, customer_id, supplier_id, text, date_added, date_edited, sent_by FROM __temp__message');
        $this->addSql('DROP TABLE __temp__message');
        $this->addSql('CREATE INDEX IDX_B6BD307F355AF43 ON message (suppliers_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_81398E09E7A1254A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, messages_id, broker_id, contact_id, name, date_added, date_edited FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, messages_id INTEGER NOT NULL, contact_id INTEGER NOT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, brokers_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO customer (id, messages_id, brokers_id, contact_id, name, date_added, date_edited) SELECT id, messages_id, broker_id, contact_id, name, date_added, date_edited FROM __temp__customer');
        $this->addSql('DROP TABLE __temp__customer');
        $this->addSql('CREATE INDEX IDX_81398E09A5905F5A ON customer (messages_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_81398E09E7A1254A ON customer (contact_id)');
        $this->addSql('CREATE INDEX IDX_81398E095316C376 ON customer (brokers_id)');
        $this->addSql('DROP INDEX IDX_B6BD307F355AF43');
        $this->addSql('DROP INDEX IDX_B6BD307FC3568B40');
        $this->addSql('DROP INDEX IDX_B6BD307F5316C376');
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id, supplier_id, customer_id FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, suppliers_id INTEGER NOT NULL, customers_id INTEGER NOT NULL, brokers_id INTEGER NOT NULL, text CLOB NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL, broker_id VARCHAR(120) DEFAULT NULL, supplier_id VARCHAR(120) DEFAULT NULL, customer_id VARCHAR(120) DEFAULT NULL)');
        $this->addSql('INSERT INTO message (id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id, supplier_id, customer_id) SELECT id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id, supplier_id, customer_id FROM __temp__message');
        $this->addSql('DROP TABLE __temp__message');
        $this->addSql('CREATE INDEX IDX_B6BD307F355AF43 ON message (suppliers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307FC3568B40 ON message (customers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307F5316C376 ON message (brokers_id)');
