 ...
 */
final class Version20210121012700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, contact_id, name, date_added, date_edited, broker_id FROM customer');
        ...
        $this->addSql('INSERT INTO customer (id, contact_id, name, date_added, date_edited, broker_id) SELECT id, contact_id, name, date_added, date_edited, broker_id FROM __temp__customer');
        ...
        $this->addSql('ALTER TABLE message ADD COLUMN broker_id INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE note ADD COLUMN broker_id INTEGER DEFAULT NULL');
        $this->addSql('DROP INDEX UNIQ_D34A04ADBDE4EC11');
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, specifications_id, name, date_added, date_edited, broker_id FROM product');
        ...
        $this->addSql('INSERT INTO product (id, specifications_id, name, date_added, date_edited, broker_id) SELECT id, specifications_id, name, date_added, date_edited, broker_id FROM __temp__product');
        $this->addSql('DROP TABLE __temp__product');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D34A04ADBDE4EC11 ON product (specifications_id)');
        $this->addSql('DROP INDEX IDX_4255D8B526ED0855');
        $this->addSql('DROP INDEX IDX_4255D8B54584665A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_note AS SELECT product_id, note_id FROM product_note');
        $this->addSql('DROP TABLE product_note');
        $this->addSql('CREATE TABLE product_note (product_id INTEGER NOT NULL, note_id INTEGER NOT NULL, PRIMARY KEY(product_id, note_id), CONSTRAINT FK_4255D8B54584665A FOREIGN KEY (product_id) REFERENCES product (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4255D8B526ED0855 FOREIGN KEY (note_id) REFERENCES note (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product_note (product_id, note_id) SELECT product_id, note_id FROM __temp__product_note');
        $this->addSql('DROP TABLE __temp__product_note');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__supplier AS SELECT id, contact_id, name, date_added, date_edited, broker_id FROM supplier');
        ...
        $this->addSql('INSERT INTO supplier (id, contact_id, name, date_added, date_edited, broker_id) SELECT id, contact_id, name, date_added, date_edited, broker_id FROM __temp__supplier');
        ...
        $this->addSql('DROP INDEX UNIQ_8FB094A16CC064FC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__symfony_demo_user AS SELECT id, broker_id, username, password, full_name, email, roles FROM symfony_demo_user');
        $this->addSql('DROP TABLE symfony_demo_user');
        $this->addSql('CREATE TABLE symfony_demo_user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, broker_id INTEGER DEFAULT NULL, username VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, full_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        , CONSTRAINT FK_8FB094A16CC064FC FOREIGN KEY (broker_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO symfony_demo_user (id, broker_id, username, password, full_name, email, roles) SELECT id, broker_id, username, password, full_name, email, roles FROM __temp__symfony_demo_user');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8FB094A16CC064FC ON symfony_demo_user (broker_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, contact_id, name, date_added, date_edited, broker_id FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contact_id INTEGER DEFAULT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, broker_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO customer (id, contact_id, name, date_added, date_edited, broker_id) SELECT id, contact_id, name, date_added, date_edited, broker_id FROM __temp__customer');
        $this->addSql('DROP TABLE __temp__customer');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_81398E09E7A1254A ON customer (contact_id)');
        $this->addSql('DROP INDEX IDX_AA6094C19395C3F3');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__note AS SELECT id, details, date_added, date_edited FROM note');
        ...
        $this->addSql('INSERT INTO note (id, details, date_added, date_edited) SELECT id, details, date_added, date_edited FROM __temp__note');
        $this->addSql('DROP TABLE __temp__note');
        $this->addSql('DROP INDEX UNIQ_D34A04ADBDE4EC11');
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, specifications_id, name, date_added, date_edited, broker_id FROM product');
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, specifications_id INTEGER NOT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, broker_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO product (id, specifications_id, name, date_added, date_edited, broker_id) SELECT id, specifications_id, name, date_added, date_edited, broker_id FROM __temp__product');
        $this->addSql('DROP TABLE __temp__product');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D34A04ADBDE4EC11 ON product (specifications_id)');
        $this->addSql('DROP INDEX IDX_4255D8B54584665A');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product_note AS SELECT product_id, note_id FROM product_note');
        $this->addSql('DROP TABLE product_note');
        $this->addSql('CREATE TABLE product_note (product_id INTEGER NOT NULL, note_id INTEGER NOT NULL, PRIMARY KEY(product_id, note_id))');
        $this->addSql('INSERT INTO product_note (product_id, note_id) SELECT product_id, note_id FROM __temp__product_note');
        $this->addSql('DROP TABLE __temp__product_note');
        $this->addSql('CREATE INDEX IDX_4255D8B54584665A ON product_note (product_id)');
        $this->addSql('CREATE INDEX IDX_4255D8B526ED0855 ON product_note (note_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__supplier AS SELECT id, contact_id, name, date_added, date_edited, broker_id FROM supplier');
        $this->addSql('DROP TABLE supplier');
        $this->addSql('CREATE TABLE supplier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contact_id INTEGER DEFAULT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, broker_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO supplier (id, contact_id, name, date_added, date_edited, broker_id) SELECT id, contact_id, name, date_added, date_edited, broker_id FROM __temp__supplier');
        $this->addSql('DROP TABLE __temp__supplier');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9B2A6C7EE7A1254A ON supplier (contact_id)');
        $this->addSql('DROP INDEX IDX_37D844602ADD6D8C');
        ...
        $this->addSql('DROP INDEX UNIQ_8FB094A1E7927C74');
        $this->addSql('DROP INDEX UNIQ_8FB094A16CC064FC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__symfony_demo_user AS SELECT id, broker_id, full_name, username, email, password, roles FROM symfony_demo_user');
        $this->addSql('DROP TABLE symfony_demo_user');
        $this->addSql('CREATE TABLE symfony_demo_user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, broker_id INTEGER DEFAULT NULL, full_name VARCHAR(255) DEFAULT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO symfony_demo_user (id, broker_id, full_name, username, email, password, roles) SELECT id, broker_id, full_name, username, email, password, roles FROM __temp__symfony_demo_user');
        $this->addSql('DROP TABLE __temp__symfony_demo_user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8FB094A1F85E0677 ON symfony_demo_user (username)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8FB094A1E7927C74 ON symfony_demo_user (email)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8FB094A16CC064FC ON symfony_demo_user (broker_id)');
