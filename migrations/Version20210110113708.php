 ...
 */
final class Version20210110113708 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, suppliers_id, customers_id, brokers_id, customer_id, broker_id, supplier_id, text, date_added, date_edited, sent_by FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, suppliers_id INTEGER NOT NULL, customers_id INTEGER NOT NULL, brokers_id INTEGER NOT NULL, customer_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, supplier_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, broker_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, text CLOB NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_B6BD307F355AF43 FOREIGN KEY (suppliers_id) REFERENCES supplier (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307FC3568B40 FOREIGN KEY (customers_id) REFERENCES customer (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F5316C376 FOREIGN KEY (brokers_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F9395C3F3 FOREIGN KEY (customer_id) REFERENCES customer (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F2ADD6D8C FOREIGN KEY (supplier_id) REFERENCES supplier (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO message (id, suppliers_id, customers_id, brokers_id, customer_id, broker_id, supplier_id, text, date_added, date_edited, sent_by) SELECT id, suppliers_id, customers_id, brokers_id, customer_id, broker_id, supplier_id, text, date_added, date_edited, sent_by FROM __temp__message');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, supplier_id, customer_id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, supplier_id VARCHAR(120) DEFAULT NULL, customer_id VARCHAR(120) DEFAULT NULL, suppliers_id INTEGER NOT NULL, customers_id INTEGER NOT NULL, brokers_id INTEGER NOT NULL, text CLOB NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL, broker_id VARCHAR(120) DEFAULT NULL)');
        $this->addSql('INSERT INTO message (id, supplier_id, customer_id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id) SELECT id, supplier_id, customer_id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id FROM __temp__message');
        $this->addSql('DROP TABLE __temp__message');
        $this->addSql('CREATE INDEX IDX_B6BD307F355AF43 ON message (suppliers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307FC3568B40 ON message (customers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307F5316C376 ON message (brokers_id)');
