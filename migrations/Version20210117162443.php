 ...
 */
final class Version20210117162443 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE note (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, broker_id INTEGER DEFAULT NULL, details CLOB DEFAULT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__symfony_demo_user AS SELECT id, username, password, roles, full_name, email FROM symfony_demo_user');
        ...
        , full_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO symfony_demo_user (id, username, password, roles, full_name, email) SELECT id, username, password, roles, full_name, email FROM __temp__symfony_demo_user');
