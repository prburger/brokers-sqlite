 ...
 */
final class Version20210120094415 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__symfony_demo_user AS SELECT id, username, password, full_name, email, roles FROM symfony_demo_user');
        ...
        $this->addSql('INSERT INTO symfony_demo_user (id, username, password, full_name, email, roles) SELECT id, username, password, full_name, email, roles FROM __temp__symfony_demo_user');
