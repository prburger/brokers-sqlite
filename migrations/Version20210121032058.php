 ...
 */
final class Version20210121032058 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, broker_id, username, password, full_name, email, roles FROM users');
        $this->addSql('DROP TABLE users');
        $this->addSql('CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, broker_id INTEGER DEFAULT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, full_name VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , CONSTRAINT FK_1483A5E96CC064FC FOREIGN KEY (broker_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO users (id, broker_id, username, password, full_name, email, roles) SELECT id, broker_id, username, password, full_name, email, roles FROM __temp__users');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE symfony_demo_user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, broker_id INTEGER DEFAULT NULL, full_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, username VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        )');
        ...
        $this->addSql('DROP INDEX UNIQ_1483A5E96CC064FC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, broker_id, full_name, username, email, password, roles FROM users');
        $this->addSql('DROP TABLE users');
        $this->addSql('CREATE TABLE users (broker_id INTEGER DEFAULT NULL, id INTEGER DEFAULT NULL, full_name CLOB DEFAULT NULL COLLATE BINARY, username CLOB DEFAULT NULL COLLATE BINARY, email CLOB DEFAULT NULL COLLATE BINARY, password CLOB DEFAULT NULL COLLATE BINARY, roles CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO users (id, broker_id, full_name, username, email, password, roles) SELECT id, broker_id, full_name, username, email, password, roles FROM __temp__users');
        $this->addSql('DROP TABLE __temp__users');
    }
}
