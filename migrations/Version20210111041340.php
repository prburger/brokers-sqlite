 ...
 */
final class Version20210111041340 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, text, date_added, date_edited, sent_by, date_sent FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text CLOB NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL COLLATE BINARY, date_sent DATE DEFAULT NULL)');
        $this->addSql('INSERT INTO message (id, text, date_added, date_edited, sent_by, date_sent) SELECT id, text, date_added, date_edited, sent_by, date_sent FROM __temp__message');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, text, date_added, date_edited, sent_by, date_sent FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text CLOB NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL, date_sent DATE DEFAULT NULL, brokers_id INTEGER NOT NULL, get_customer_id INTEGER DEFAULT NULL, supplier_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO message (id, text, date_added, date_edited, sent_by, date_sent) SELECT id, text, date_added, date_edited, sent_by, date_sent FROM __temp__message');
        $this->addSql('DROP TABLE __temp__message');
