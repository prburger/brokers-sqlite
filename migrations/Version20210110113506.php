 ...
 */
final class Version20210110113506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, suppliers_id INTEGER NOT NULL, customers_id INTEGER NOT NULL, brokers_id INTEGER NOT NULL, customer_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, broker_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, supplier_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, text CLOB NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_B6BD307F355AF43 FOREIGN KEY (suppliers_id) REFERENCES supplier (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307FC3568B40 FOREIGN KEY (customers_id) REFERENCES customer (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F5316C376 FOREIGN KEY (brokers_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F9395C3F3 FOREIGN KEY (customer_id) REFERENCES customer (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, contact_id, broker_id, name, date_added, date_edited FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contact_id INTEGER NOT NULL, broker_id INTEGER DEFAULT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, messages_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO customer (id, contact_id, broker_id, name, date_added, date_edited) SELECT id, contact_id, broker_id, name, date_added, date_edited FROM __temp__customer');
        $this->addSql('DROP TABLE __temp__customer');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_81398E09E7A1254A ON customer (contact_id)');
        $this->addSql('CREATE INDEX IDX_81398E096CC064FC ON customer (broker_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, customer_id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id, supplier_id FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, customer_id VARCHAR(120) DEFAULT NULL, suppliers_id INTEGER NOT NULL, customers_id INTEGER NOT NULL, brokers_id INTEGER NOT NULL, text CLOB NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL, broker_id VARCHAR(120) DEFAULT NULL, supplier_id VARCHAR(120) DEFAULT NULL)');
        $this->addSql('INSERT INTO message (id, customer_id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id, supplier_id) SELECT id, customer_id, suppliers_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id, supplier_id FROM __temp__message');
        $this->addSql('DROP TABLE __temp__message');
        $this->addSql('CREATE INDEX IDX_B6BD307F355AF43 ON message (suppliers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307FC3568B40 ON message (customers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307F5316C376 ON message (brokers_id)');
