 ...
 */
final class Version20210110113217 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, contact_id, messages_id, broker_id, name, date_added, date_edited FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contact_id INTEGER NOT NULL, messages_id INTEGER NOT NULL, broker_id INTEGER DEFAULT NULL, name VARCHAR(120) NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, CONSTRAINT FK_81398E09A5905F5A FOREIGN KEY (messages_id) REFERENCES message (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_81398E09E7A1254A FOREIGN KEY (contact_id) REFERENCES contact (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_81398E096CC064FC FOREIGN KEY (broker_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO customer (id, contact_id, messages_id, broker_id, name, date_added, date_edited) SELECT id, contact_id, messages_id, broker_id, name, date_added, date_edited FROM __temp__customer');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_81398E09E7A1254A');
        $this->addSql('DROP INDEX IDX_81398E096CC064FC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, messages_id, contact_id, broker_id, name, date_added, date_edited FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, messages_id INTEGER NOT NULL, contact_id INTEGER NOT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, broker_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO customer (id, messages_id, contact_id, broker_id, name, date_added, date_edited) SELECT id, messages_id, contact_id, broker_id, name, date_added, date_edited FROM __temp__customer');
        $this->addSql('DROP TABLE __temp__customer');
        $this->addSql('CREATE INDEX IDX_81398E09A5905F5A ON customer (messages_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_81398E09E7A1254A ON customer (contact_id)');
        $this->addSql('CREATE INDEX IDX_81398E096CC064FC ON customer (broker_id)');
