 ...
 */
final class Version20210110113959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, customers_id, brokers_id, customer_id, broker_id, text, date_added, date_edited, sent_by FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, customers_id INTEGER NOT NULL, brokers_id INTEGER NOT NULL, customer_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, broker_id VARCHAR(120) DEFAULT NULL COLLATE BINARY, text CLOB NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_B6BD307FC3568B40 FOREIGN KEY (customers_id) REFERENCES customer (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F5316C376 FOREIGN KEY (brokers_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F9395C3F3 FOREIGN KEY (customer_id) REFERENCES customer (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO message (id, customers_id, brokers_id, customer_id, broker_id, text, date_added, date_edited, sent_by) SELECT id, customers_id, brokers_id, customer_id, broker_id, text, date_added, date_edited, sent_by FROM __temp__message');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B6BD307F5316C376');
        $this->addSql('DROP INDEX IDX_B6BD307F9395C3F3');
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, customer_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, customer_id VARCHAR(120) DEFAULT NULL, customers_id INTEGER NOT NULL, brokers_id INTEGER NOT NULL, text CLOB NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL, broker_id VARCHAR(120) DEFAULT NULL, suppliers_id INTEGER NOT NULL, supplier_id VARCHAR(120) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO message (id, customer_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id) SELECT id, customer_id, customers_id, brokers_id, text, date_added, date_edited, sent_by, broker_id FROM __temp__message');
        $this->addSql('DROP TABLE __temp__message');
        $this->addSql('CREATE INDEX IDX_B6BD307FC3568B40 ON message (customers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307F5316C376 ON message (brokers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307F9395C3F3 ON message (customer_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__supplier AS SELECT id, contact_id, broker_id, name, date_added, date_edited FROM supplier');
        $this->addSql('DROP TABLE supplier');
        $this->addSql('CREATE TABLE supplier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contact_id INTEGER NOT NULL, broker_id INTEGER NOT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, message_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO supplier (id, contact_id, broker_id, name, date_added, date_edited) SELECT id, contact_id, broker_id, name, date_added, date_edited FROM __temp__supplier');
        $this->addSql('DROP TABLE __temp__supplier');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9B2A6C7EE7A1254A ON supplier (contact_id)');
        $this->addSql('CREATE INDEX IDX_9B2A6C7E6CC064FC ON supplier (broker_id)');
