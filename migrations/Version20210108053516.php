 ...
 */
final class Version20210108053516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_FB00E5C26CC064FC');
        $this->addSql('DROP INDEX IDX_FB00E5C2E7A1254A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__broker_contact AS SELECT broker_id, contact_id FROM broker_contact');
        $this->addSql('DROP TABLE broker_contact');
        $this->addSql('CREATE TABLE broker_contact (broker_id INTEGER NOT NULL, contact_id INTEGER NOT NULL, PRIMARY KEY(broker_id, contact_id), CONSTRAINT FK_FB00E5C26CC064FC FOREIGN KEY (broker_id) REFERENCES broker (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_FB00E5C2E7A1254A FOREIGN KEY (contact_id) REFERENCES contact (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO broker_contact (broker_id, contact_id) SELECT broker_id, contact_id FROM __temp__broker_contact');
        $this->addSql('DROP TABLE __temp__broker_contact');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__contact AS SELECT id, city, country, phone, mobile, email, whatsapp, wechat, skype, date_added, date_edited FROM contact');
        $this->addSql('DROP TABLE contact');
        $this->addSql('CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, city VARCHAR(120) DEFAULT NULL COLLATE BINARY, country VARCHAR(120) DEFAULT NULL COLLATE BINARY, phone VARCHAR(60) DEFAULT NULL COLLATE BINARY, mobile VARCHAR(60) DEFAULT NULL COLLATE BINARY, email VARCHAR(120) DEFAULT NULL COLLATE BINARY, whatsapp VARCHAR(120) DEFAULT NULL COLLATE BINARY, wechat VARCHAR(120) DEFAULT NULL COLLATE BINARY, skype VARCHAR(120) DEFAULT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL)');
        $this->addSql('INSERT INTO contact (id, city, country, phone, mobile, email, whatsapp, wechat, skype, date_added, date_edited) SELECT id, city, country, phone, mobile, email, whatsapp, wechat, skype, date_added, date_edited FROM __temp__contact');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_C6F5157F6CC064FC ON broker_supplier (broker_id)');
        $this->addSql('CREATE INDEX IDX_C6F5157F2ADD6D8C ON broker_supplier (supplier_id)');
        $this->addSql('ALTER TABLE contact ADD COLUMN contact_id INTEGER DEFAULT NULL');
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, name, date_added, date_edited FROM customer');
        $this->addSql('DROP TABLE customer');
        $this->addSql('CREATE TABLE customer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, contact_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO customer (id, name, date_added, date_edited) SELECT id, name, date_added, date_edited FROM __temp__customer');
        $this->addSql('DROP TABLE __temp__customer');
