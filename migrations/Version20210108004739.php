 ...
 */
final class Version20210108004739 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE note (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, text CLOB NOT NULL)');
        $this->addSql('INSERT INTO note (id, text, date_added, date_edited) SELECT id, details, date_added, date_edited FROM __temp__note');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_CF97A0139395C3F3 ON customer_product (customer_id)');
        $this->addSql('CREATE INDEX IDX_CF97A0134584665A ON customer_product (product_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__note AS SELECT id, text, date_added, date_edited FROM note');
        $this->addSql('DROP TABLE note');
        $this->addSql('CREATE TABLE note (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, details CLOB NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO note (id, details, date_added, date_edited) SELECT id, text, date_added, date_edited FROM __temp__note');
        $this->addSql('DROP TABLE __temp__note');
        $this->addSql('DROP INDEX IDX_37D844602ADD6D8C');
        $this->addSql('DROP INDEX IDX_37D84460537A1329');
        $this->addSql('CREATE TEMPORARY TABLE __temp__supplier_message AS SELECT supplier_id, message_id FROM supplier_message');
