 ...
 */
final class Version20210108004352 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, text CLOB NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_CF97A0139395C3F3 ON customer_product (customer_id)');
        $this->addSql('CREATE INDEX IDX_CF97A0134584665A ON customer_product (product_id)');
        $this->addSql('ALTER TABLE message ADD COLUMN sent_by VARCHAR(120) DEFAULT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX IDX_EE78A7EF26ED0855');
        $this->addSql('DROP INDEX IDX_EE78A7EF6CC064FC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__note_broker AS SELECT note_id, broker_id FROM note_broker');
        $this->addSql('DROP TABLE note_broker');
