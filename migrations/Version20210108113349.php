 ...
 */
final class Version20210108113349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__product AS SELECT id, name, date_added, date_edited FROM product');
        ...
        $this->addSql('INSERT INTO product (id, name, date_added, date_edited) SELECT id, name, date_added, date_edited FROM __temp__product');
