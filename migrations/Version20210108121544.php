 ...
 */
final class Version20210108121544 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO product (id, specification_id, name, date_added, date_edited) SELECT id, customer_id, name, date_added, date_edited FROM __temp__product');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE product');
        $this->addSql('CREATE TABLE product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, customer_id INTEGER NOT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, CONSTRAINT FK_D34A04AD908E2FFE FOREIGN KEY (customer_id) REFERENCES specification (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO product (id, customer_id, name, date_added, date_edited) SELECT id, specification_id, name, date_added, date_edited FROM __temp__product');
        $this->addSql('DROP TABLE __temp__product');
