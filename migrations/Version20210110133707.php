 ...
 */
final class Version20210110133707 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B6BD307FCA22092A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, brokers_id, get_customer_id, supplier_id, text, date_added, date_edited, sent_by FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, brokers_id INTEGER NOT NULL, get_customer_id INTEGER DEFAULT NULL, supplier_id INTEGER DEFAULT NULL, text CLOB NOT NULL COLLATE BINARY, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_B6BD307F5316C376 FOREIGN KEY (brokers_id) REFERENCES broker (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307FCA22092A FOREIGN KEY (get_customer_id) REFERENCES customer (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B6BD307F2ADD6D8C FOREIGN KEY (supplier_id) REFERENCES supplier (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO message (id, brokers_id, get_customer_id, supplier_id, text, date_added, date_edited, sent_by) SELECT id, brokers_id, get_customer_id, supplier_id, text, date_added, date_edited, sent_by FROM __temp__message');
        ...
        $this->addSql('CREATE INDEX IDX_B6BD307FCA22092A ON message (get_customer_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__message AS SELECT id, brokers_id, get_customer_id, supplier_id, text, date_added, date_edited, sent_by FROM message');
        $this->addSql('DROP TABLE message');
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, brokers_id INTEGER NOT NULL, get_customer_id INTEGER DEFAULT NULL, supplier_id INTEGER DEFAULT NULL, text CLOB NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, sent_by VARCHAR(120) DEFAULT NULL)');
        $this->addSql('INSERT INTO message (id, brokers_id, get_customer_id, supplier_id, text, date_added, date_edited, sent_by) SELECT id, brokers_id, get_customer_id, supplier_id, text, date_added, date_edited, sent_by FROM __temp__message');
        $this->addSql('DROP TABLE __temp__message');
        $this->addSql('CREATE INDEX IDX_B6BD307F5316C376 ON message (brokers_id)');
        $this->addSql('CREATE INDEX IDX_B6BD307FCA22092A ON message (get_customer_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__supplier AS SELECT id, contact_id, broker_id, name, date_added, date_edited FROM supplier');
        $this->addSql('DROP TABLE supplier');
        $this->addSql('CREATE TABLE supplier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, contact_id INTEGER NOT NULL, name VARCHAR(120) NOT NULL, date_added DATE NOT NULL, date_edited DATE NOT NULL, broker_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO supplier (id, contact_id, broker_id, name, date_added, date_edited) SELECT id, contact_id, broker_id, name, date_added, date_edited FROM __temp__supplier');
        $this->addSql('DROP TABLE __temp__supplier');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9B2A6C7EE7A1254A ON supplier (contact_id)');
        $this->addSql('CREATE INDEX IDX_9B2A6C7E6CC064FC ON supplier (broker_id)');
